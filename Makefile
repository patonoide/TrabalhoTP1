...
AllDomObj = ${PathToObj}ticket_DOM.o ${PathToObj}creditcard_DOM.o ${PathToObj}presentation_DOM.o ${PathToObj}abstract_DOM.o ${PathToObj}event_DOM.o ${PathToObj}user_DOM.o
...
AllTestObj = ${PathToObj}ticket_testes.o ${PathToObj}creditcard_testes.o ${PathToObj}presentation_testes.o ${PathToObj}event_testes.o ${PathToObj}testes.o
# Caso adicione algum .o adicione a compilação dele junto as outras, seguindo também o padrão:
...
${PathToObj}user_DOM.o: ${PathToDom}user_DOM.cpp ${PathToDom}user_DOM.hpp
	$(call compile_obj_dom,user_DOM.cpp,user_DOM.o)

${PathToObj}event_DOM.o: ${PathToDom}event_DOM.cpp ${PathToDom}event_DOM.hpp
	$(call compile_obj_dom,event_DOM.cpp,event_DOM.o)
...
${PathToObj}event_testes.o: ${PathToTests}dominios/event_testes.cpp ${PathToTests}testes.hpp
	$(call compile_obj_test,dominios/event_testes.cpp,event_testes.o)
#############################################################
